...
# Exportar do anki
arquivo_html = "4000 Essential English Words.html"
# CSV Gerado
csv_saida    = "4000 Essential English Words\db.csv"
# pasta onde estão as midias
media_dir    = "4000 Essential English Words\midias"
